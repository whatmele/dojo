...
May include: which repos/paths to include, partial staging, whether to **reuse a prior code review** in the message. Session materials under `.dojo/sessions/${dojo_current_session_id}/` (PRD, research, design, tasks) help explain **why** and **which repos** changed.
